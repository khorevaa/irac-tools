...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестДолжен_ЗапуститьКомандуИЗавершитьсяСОшибкойПоискаУтилитыRAC");
...
// Процедура - тест
//
Процедура ТестДолжен_ЗапуститьКомандуИЗавершитьсяСОшибкойПоискаУтилитыRAC() Экспорт
	...
	Утверждения.ПроверитьВхождение(ТекстОшибки,
	    "Ошибка определения версии платформы. Файл </opt/1C/v8.3/x86_64/rac> не существует");

КонецПроцедуры // ТестДолжен_ЗапуститьКомандуИЗавершитьсяСОшибкойПоискаУтилитыRAC()
